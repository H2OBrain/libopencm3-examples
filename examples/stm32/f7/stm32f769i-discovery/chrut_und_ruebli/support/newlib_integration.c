...
caddr_t  _sbrk ( ptrdiff_t incr ) __attribute__((used));
//void __malloc_lock(struct _reent *_r) __attribute__((used));
//void __malloc_unlock(struct _reent *_r) __attribute__((used));
